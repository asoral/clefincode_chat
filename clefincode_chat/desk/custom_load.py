...
from frappe.desk.form.load import run_onload ,set_link_titles, _get_communications, add_comments, update_user_info, get_attachments, get_versions, get_assignments, get_doc_permissions, get_additional_timeline_content, get_milestones,is_document_followed, get_tags, get_document_email
from eps.eps.api import get_point_logs
...
def get_docinfo(doc=None, doctype=None, name=None):
	...
	if docinfo.additional_timeline_content:
		docinfo.additional_timeline_content = [
